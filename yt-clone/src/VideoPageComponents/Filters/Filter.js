...
function Filter() {
  return (
    <div className='filter'>
        ...
        <div className='single-filter'>
            <span className='filter-items'>Git</span>
        </div>

        <div className='single-filter'>
            <span className='filter-items'>C++</span>
        </div>

        <div className='single-filter'>
            <span className='filter-items'>Listenable</span>
        </div>

        <div className='single-filter'>
            <span className='filter-items'>Related</span>
        </div>
